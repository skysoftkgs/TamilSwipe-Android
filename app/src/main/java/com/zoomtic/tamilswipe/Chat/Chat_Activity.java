package com.zoomtic.tamilswipe.Chat;
...
import com.zoomtic.tamilswipe.Chat.Audio.Play_Audio_F;
import com.zoomtic.tamilswipe.Chat.Audio.SendAudio;
...
import com.zoomtic.tamilswipe.See_Full_Image_F;
...
public class Chat_Activity extends Fragment {
    ...
    private void openCameraIntent() {
        ...
        if(pictureIntent.resolveActivity(getActivity().getPackageManager()) != null){
            ...
            if (photoFile != null) {
                Uri photoURI = FileProvider.getUriForFile(context.getApplicationContext(), "com.zoomtic.tamilswipe.fileprovider", photoFile);
